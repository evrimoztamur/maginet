...
|---|---|---|---|
| Easy | 96.7% [83.3, 99.4]; n=30; U=0; range 96.7–96.7% | 83.3% [66.4, 92.7]; n=30; U=0; range 83.3–83.3% | 86.7% [70.3, 94.7]; n=30; U=0; range 86.7–86.7% |
| Normal | 96.7% [83.3, 99.4]; n=30; U=0; range 96.7–96.7% | 83.3% [66.4, 92.7]; n=30; U=0; range 83.3–83.3% | 86.7% [70.3, 94.7]; n=30; U=0; range 86.7–86.7% |
...
- Easy/Easy: W/L/D/U 29/1/0/0; mean 8.5 plies (5–22); 5306 nodes; node saturation 0.0%; fallbacks 0/256.

- Easy/Normal: W/L/D/U 25/4/1/0; mean 8.1 plies (5–22); 20214 nodes; node saturation 0.0%; fallbacks 0/243.

- Easy/Hard: W/L/D/U 26/4/0/0; mean 9.3 plies (5–21); 182904 nodes; node saturation 0.0%; fallbacks 0/280.

- Normal/Easy: W/L/D/U 29/1/0/0; mean 9.1 plies (5–17); 23049 nodes; node saturation 0.0%; fallbacks 0/273.

- Normal/Normal: W/L/D/U 25/5/0/0; mean 10.1 plies (5–20); 44055 nodes; node saturation 0.0%; fallbacks 0/303.

- Normal/Hard: W/L/D/U 26/4/0/0; mean 10.2 plies (5–18); 203475 nodes; node saturation 0.0%; fallbacks 0/307.

- Hard/Easy: W/L/D/U 30/0/0/0; mean 10.5 plies (5–22); 264979 nodes; node saturation 0.0%; fallbacks 0/315.

- Hard/Normal: W/L/D/U 30/0/0/0; mean 9.1 plies (5–19); 256875 nodes; node saturation 0.0%; fallbacks 0/274.

- Hard/Hard: W/L/D/U 30/0/0/0; mean 10.3 plies (5–18); 506387 nodes; node saturation 0.0%; fallbacks 0/309.
