...
|---|---|---|---|
| Easy | 93.3% [78.7, 98.2]; n=30; U=0; range 93.3–93.3% | 76.7% [59.1, 88.2]; n=30; U=0; range 76.7–76.7% | 76.7% [59.1, 88.2]; n=30; U=0; range 76.7–76.7% |
| Normal | 100.0% [88.6, 100.0]; n=30; U=0; range 100.0–100.0% | 96.7% [83.3, 99.4]; n=30; U=0; range 96.7–96.7% | 100.0% [88.6, 100.0]; n=30; U=0; range 100.0–100.0% |
| Hard | 100.0% [88.6, 100.0]; n=30; U=0; range 100.0–100.0% | 96.7% [83.3, 99.4]; n=30; U=0; range 96.7–96.7% | 100.0% [88.6, 100.0]; n=30; U=0; range 100.0–100.0% |

- Easy/Easy: W/L/D/U 28/2/0/0; mean 19.9 plies (13–30); 25125 nodes; node saturation 0.0%; fallbacks 0/596.

- Easy/Normal: W/L/D/U 23/6/1/0; mean 20.6 plies (9–32); 169221 nodes; node saturation 0.0%; fallbacks 0/619.

- Easy/Hard: W/L/D/U 23/7/0/0; mean 21.9 plies (9–40); 3207267 nodes; node saturation 15.8%; fallbacks 0/658.

- Normal/Easy: W/L/D/U 30/0/0/0; mean 18.9 plies (11–27); 177531 nodes; node saturation 0.0%; fallbacks 0/567.

- Normal/Normal: W/L/D/U 29/1/0/0; mean 21.3 plies (13–40); 307489 nodes; node saturation 0.0%; fallbacks 0/638.

- Normal/Hard: W/L/D/U 30/0/0/0; mean 21.1 plies (13–27); 3431309 nodes; node saturation 17.0%; fallbacks 0/634.

- Hard/Easy: W/L/D/U 30/0/0/0; mean 25.9 plies (15–41); 3801189 nodes; node saturation 14.9%; fallbacks 0/776.

- Hard/Normal: W/L/D/U 29/0/1/0; mean 24.5 plies (13–44); 4053138 nodes; node saturation 16.1%; fallbacks 0/735.

- Hard/Hard: W/L/D/U 30/0/0/0; mean 24.4 plies (15–40); 7249038 nodes; node saturation 28.4%; fallbacks 0/733.
...
- Custom scenario: player Easy→Hard sensitivity against Normal: +20.0 points.
