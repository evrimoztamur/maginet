...
|---|---|---|---|
| Easy | 63.3% [45.5, 78.1]; n=30; U=0; range 63.3–63.3% | 30.0% [16.7, 47.9]; n=30; U=0; range 30.0–30.0% | 6.7% [1.8, 21.3]; n=30; U=0; range 6.7–6.7% |
| Normal | 70.0% [52.1, 83.3]; n=30; U=0; range 70.0–70.0% | 53.3% [36.1, 69.8]; n=30; U=0; range 53.3–53.3% | 6.7% [1.8, 21.3]; n=30; U=0; range 6.7–6.7% |
| Hard | 73.3% [55.6, 85.8]; n=30; U=0; range 73.3–73.3% | 60.0% [42.3, 75.4]; n=30; U=0; range 60.0–60.0% | 16.7% [7.3, 33.6]; n=30; U=0; range 16.7–16.7% |

- Easy/Easy: W/L/D/U 19/11/0/0; mean 20.1 plies (12–29); 18838 nodes; node saturation 0.0%; fallbacks 0/603.

- Easy/Normal: W/L/D/U 9/20/1/0; mean 19.4 plies (14–28); 108933 nodes; node saturation 0.0%; fallbacks 0/583.

- Easy/Hard: W/L/D/U 2/28/0/0; mean 19.9 plies (12–30); 2915555 nodes; node saturation 8.7%; fallbacks 0/597.

- Normal/Easy: W/L/D/U 21/8/1/0; mean 19.3 plies (12–32); 122966 nodes; node saturation 0.0%; fallbacks 0/579.

- Normal/Normal: W/L/D/U 16/12/2/0; mean 17.2 plies (12–29); 189511 nodes; node saturation 0.0%; fallbacks 0/516.

- Normal/Hard: W/L/D/U 2/27/1/0; mean 21.2 plies (14–33); 2859676 nodes; node saturation 7.7%; fallbacks 0/637.

- Hard/Easy: W/L/D/U 22/7/1/0; mean 22.1 plies (15–32); 3463326 nodes; node saturation 11.9%; fallbacks 0/664.

- Hard/Normal: W/L/D/U 18/10/2/0; mean 21.8 plies (17–35); 3603620 nodes; node saturation 13.3%; fallbacks 0/653.

- Hard/Hard: W/L/D/U 5/22/3/0; mean 21.6 plies (16–36); 6664056 nodes; node saturation 29.6%; fallbacks 0/648.
...
- Custom scenario: player Easy→Hard sensitivity against Normal: +30.0 points.
