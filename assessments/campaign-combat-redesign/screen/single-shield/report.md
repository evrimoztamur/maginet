...
|---|---|---|---|
| Easy | 50.0% [33.2, 66.8]; n=30; U=0; range 50.0–50.0% | 20.0% [9.5, 37.3]; n=30; U=0; range 20.0–20.0% | 13.3% [5.3, 29.7]; n=30; U=0; range 13.3–13.3% |
| Normal | 100.0% [88.6, 100.0]; n=30; U=0; range 100.0–100.0% | 43.3% [27.4, 60.8]; n=30; U=0; range 43.3–43.3% | 30.0% [16.7, 47.9]; n=30; U=0; range 30.0–30.0% |
| Hard | 86.7% [70.3, 94.7]; n=30; U=0; range 86.7–86.7% | 76.7% [59.1, 88.2]; n=30; U=0; range 76.7–76.7% | 63.3% [45.5, 78.1]; n=30; U=0; range 63.3–63.3% |

- Easy/Easy: W/L/D/U 15/14/1/0; mean 22.0 plies (13–33); 28755 nodes; node saturation 0.0%; fallbacks 0/659.

- Easy/Normal: W/L/D/U 6/20/4/0; mean 20.3 plies (14–40); 207210 nodes; node saturation 0.0%; fallbacks 0/610.

- Easy/Hard: W/L/D/U 4/25/1/0; mean 21.2 plies (14–28); 3488070 nodes; node saturation 22.6%; fallbacks 0/636.

- Normal/Easy: W/L/D/U 30/0/0/0; mean 20.4 plies (13–31); 228750 nodes; node saturation 0.0%; fallbacks 0/613.

- Normal/Normal: W/L/D/U 13/13/4/0; mean 24.5 plies (13–38); 390503 nodes; node saturation 0.0%; fallbacks 0/735.

- Normal/Hard: W/L/D/U 9/20/1/0; mean 22.7 plies (14–32); 3517523 nodes; node saturation 19.5%; fallbacks 0/681.

- Hard/Easy: W/L/D/U 26/4/0/0; mean 21.3 plies (13–33); 3828193 nodes; node saturation 24.7%; fallbacks 0/640.

- Hard/Normal: W/L/D/U 23/6/1/0; mean 22.1 plies (14–29); 3868034 nodes; node saturation 23.5%; fallbacks 0/664.

- Hard/Hard: W/L/D/U 19/11/0/0; mean 23.4 plies (14–35); 7191500 nodes; node saturation 41.9%; fallbacks 0/701.
