...
Exploratory simulated-agent difficulty; not validated human difficulty. 255 / 264 matchups complete, 7650 games. Red is the player. Seed 1, 30 games per matchup, 200-ply safety limit. Node caps are analysis defaults, not browser time equivalents.
...
| Player / opponent | Easy | Normal | Hard |
|---|---|---|---|
| Easy | 43.3% [27.4, 60.8]; n=30; U=0; range 43.3–43.3% | 23.3% [11.8, 40.9]; n=30; U=0; range 23.3–23.3% | 50.0% [33.2, 66.8]; n=30; U=0; range 50.0–50.0% |
| Normal | 73.3% [55.6, 85.8]; n=30; U=0; range 73.3–73.3% | 63.3% [45.5, 78.1]; n=30; U=0; range 63.3–63.3% | 46.7% [30.2, 63.9]; n=30; U=0; range 46.7–46.7% |
| Hard | 93.3% [78.7, 98.2]; n=30; U=0; range 93.3–93.3% | 96.7% [83.3, 99.4]; n=30; U=0; range 96.7–96.7% | 93.3% [78.7, 98.2]; n=30; U=0; range 93.3–93.3% |

- Easy/Easy: W/L/D/U 13/15/2/0; mean 15.5 plies (6–34); 13363 nodes; node saturation 0.0%; fallbacks 0/465.

- Easy/Normal: W/L/D/U 7/21/2/0; mean 9.5 plies (5–34); 53561 nodes; node saturation 0.0%; fallbacks 0/284.

- Easy/Hard: W/L/D/U 15/15/0/0; mean 10.9 plies (5–29); 735417 nodes; node saturation 0.3%; fallbacks 0/327.

- Normal/Easy: W/L/D/U 22/8/0/0; mean 9.3 plies (5–29); 70889 nodes; node saturation 0.0%; fallbacks 0/279.

- Normal/Normal: W/L/D/U 19/11/0/0; mean 8.6 plies (5–23); 110829 nodes; node saturation 0.0%; fallbacks 0/259.

- Normal/Hard: W/L/D/U 14/15/1/0; mean 11.2 plies (5–39); 685234 nodes; node saturation 0.0%; fallbacks 0/337.

- Hard/Easy: W/L/D/U 28/2/0/0; mean 17.5 plies (5–29); 1160201 nodes; node saturation 5.9%; fallbacks 0/526.

- Hard/Normal: W/L/D/U 29/1/0/0; mean 15.1 plies (5–35); 1142381 nodes; node saturation 6.8%; fallbacks 0/453.

- Hard/Hard: W/L/D/U 28/2/0/0; mean 10.9 plies (5–29); 1796517 nodes; node saturation 10.1%; fallbacks 0/326.
...
| Player / opponent | Easy | Normal | Hard |
|---|---|---|---|
| Easy | 66.7% [48.8, 80.8]; n=30; U=0; range 66.7–66.7% | 43.3% [27.4, 60.8]; n=30; U=0; range 43.3–43.3% | 40.0% [24.6, 57.7]; n=30; U=0; range 40.0–40.0% |
| Normal | 80.0% [62.7, 90.5]; n=30; U=0; range 80.0–80.0% | 63.3% [45.5, 78.1]; n=30; U=0; range 63.3–63.3% | 63.3% [45.5, 78.1]; n=30; U=0; range 63.3–63.3% |
| Hard | 93.3% [78.7, 98.2]; n=30; U=0; range 93.3–93.3% | 80.0% [62.7, 90.5]; n=30; U=0; range 80.0–80.0% | 86.7% [70.3, 94.7]; n=30; U=0; range 86.7–86.7% |

- Easy/Easy: W/L/D/U 20/9/1/0; mean 8.7 plies (4–32); 6477 nodes; node saturation 0.0%; fallbacks 0/262.

- Easy/Normal: W/L/D/U 13/17/0/0; mean 7.4 plies (4–12); 26765 nodes; node saturation 0.0%; fallbacks 0/223.

- Easy/Hard: W/L/D/U 12/18/0/0; mean 9.0 plies (4–16); 320632 nodes; node saturation 0.0%; fallbacks 0/270.

- Normal/Easy: W/L/D/U 24/6/0/0; mean 8.6 plies (4–24); 32505 nodes; node saturation 0.0%; fallbacks 0/258.

- Normal/Normal: W/L/D/U 19/11/0/0; mean 8.6 plies (4–18); 57208 nodes; node saturation 0.0%; fallbacks 0/257.

- Normal/Hard: W/L/D/U 19/11/0/0; mean 9.8 plies (4–21); 375452 nodes; node saturation 0.0%; fallbacks 0/293.

- Hard/Easy: W/L/D/U 28/2/0/0; mean 10.7 plies (4–31); 326803 nodes; node saturation 0.0%; fallbacks 0/320.

- Hard/Normal: W/L/D/U 24/6/0/0; mean 9.2 plies (4–25); 326538 nodes; node saturation 0.0%; fallbacks 0/276.

- Hard/Hard: W/L/D/U 26/4/0/0; mean 10.5 plies (4–25); 680438 nodes; node saturation 0.0%; fallbacks 0/316.
...
| Player / opponent | Easy | Normal | Hard |
|---|---|---|---|
| Easy | 56.7% [39.2, 72.6]; n=30; U=0; range 56.7–56.7% | 20.0% [9.5, 37.3]; n=30; U=0; range 20.0–20.0% | 3.3% [0.6, 16.7]; n=30; U=0; range 3.3–3.3% |
| Normal | 80.0% [62.7, 90.5]; n=30; U=0; range 80.0–80.0% | 43.3% [27.4, 60.8]; n=30; U=0; range 43.3–43.3% | 16.7% [7.3, 33.6]; n=30; U=0; range 16.7–16.7% |
| Hard | 93.3% [78.7, 98.2]; n=30; U=0; range 93.3–93.3% | 80.0% [62.7, 90.5]; n=30; U=0; range 80.0–80.0% | 43.3% [27.4, 60.8]; n=30; U=0; range 43.3–43.3% |

- Easy/Easy: W/L/D/U 17/13/0/0; mean 28.3 plies (20–50); 31026 nodes; node saturation 0.0%; fallbacks 0/849.

- Easy/Normal: W/L/D/U 6/23/1/0; mean 27.3 plies (16–61); 207872 nodes; node saturation 0.0%; fallbacks 0/818.

- Easy/Hard: W/L/D/U 1/28/1/0; mean 26.9 plies (12–40); 3670856 nodes; node saturation 16.2%; fallbacks 0/807.

- Normal/Easy: W/L/D/U 24/6/0/0; mean 26.7 plies (13–40); 230342 nodes; node saturation 0.0%; fallbacks 0/802.

- Normal/Normal: W/L/D/U 13/14/3/0; mean 29.6 plies (14–52); 414336 nodes; node saturation 0.0%; fallbacks 0/889.

- Normal/Hard: W/L/D/U 5/25/0/0; mean 27.8 plies (18–48); 4119024 nodes; node saturation 17.3%; fallbacks 0/833.

- Hard/Easy: W/L/D/U 28/2/0/0; mean 29.3 plies (19–45); 4185099 nodes; node saturation 17.7%; fallbacks 0/880.

- Hard/Normal: W/L/D/U 24/5/1/0; mean 30.7 plies (21–49); 4334172 nodes; node saturation 17.1%; fallbacks 0/922.

- Hard/Hard: W/L/D/U 13/17/0/0; mean 31.2 plies (20–63); 8584883 nodes; node saturation 33.1%; fallbacks 0/937.
...
| Player / opponent | Easy | Normal | Hard |
|---|---|---|---|
| Easy | 40.0% [24.6, 57.7]; n=30; U=0; range 40.0–40.0% | 0.0% [0.0, 11.4]; n=30; U=0; range 0.0–0.0% | 10.0% [3.5, 25.6]; n=30; U=0; range 10.0–10.0% |
| Normal | 83.3% [66.4, 92.7]; n=30; U=0; range 83.3–83.3% | 63.3% [45.5, 78.1]; n=30; U=0; range 63.3–63.3% | 23.3% [11.8, 40.9]; n=30; U=0; range 23.3–23.3% |
| Hard | 96.7% [83.3, 99.4]; n=30; U=0; range 96.7–96.7% | 93.3% [78.7, 98.2]; n=30; U=0; range 93.3–93.3% | 63.3% [45.5, 78.1]; n=30; U=0; range 63.3–63.3% |

- Easy/Easy: W/L/D/U 12/15/3/0; mean 45.5 plies (22–76); 85851 nodes; node saturation 0.0%; fallbacks 0/1365.

- Easy/Normal: W/L/D/U 0/28/2/0; mean 42.5 plies (24–59); 781186 nodes; node saturation 0.0%; fallbacks 0/1275.

- Easy/Hard: W/L/D/U 3/27/0/0; mean 44.2 plies (28–70); 9755765 nodes; node saturation 30.3%; fallbacks 0/1325.

- Normal/Easy: W/L/D/U 25/5/0/0; mean 40.3 plies (27–65); 818496 nodes; node saturation 0.0%; fallbacks 0/1209.

- Normal/Normal: W/L/D/U 19/11/0/0; mean 45.7 plies (25–68); 1550291 nodes; node saturation 0.0%; fallbacks 0/1371.

- Normal/Hard: W/L/D/U 7/22/1/0; mean 44.6 plies (29–66); 10183976 nodes; node saturation 28.7%; fallbacks 0/1338.

- Hard/Easy: W/L/D/U 29/1/0/0; mean 40.3 plies (25–67); 8804187 nodes; node saturation 30.0%; fallbacks 0/1209.

- Hard/Normal: W/L/D/U 28/2/0/0; mean 42.5 plies (29–61); 9699560 nodes; node saturation 28.9%; fallbacks 0/1275.

- Hard/Hard: W/L/D/U 19/6/5/0; mean 42.2 plies (26–65); 16238944 nodes; node saturation 51.1%; fallbacks 0/1266.
...
| Player / opponent | Easy | Normal | Hard |
|---|---|---|---|
| Easy | 36.7% [21.9, 54.5]; n=30; U=0; range 36.7–36.7% | 30.0% [16.7, 47.9]; n=30; U=0; range 30.0–30.0% | 26.7% [14.2, 44.4]; n=30; U=0; range 26.7–26.7% |
| Normal | 53.3% [36.1, 69.8]; n=30; U=0; range 53.3–53.3% | 46.7% [30.2, 63.9]; n=30; U=0; range 46.7–46.7% | 43.3% [27.4, 60.8]; n=30; U=0; range 43.3–43.3% |
| Hard | 76.7% [59.1, 88.2]; n=30; U=0; range 76.7–76.7% | 86.7% [70.3, 94.7]; n=30; U=0; range 86.7–86.7% | 83.3% [66.4, 92.7]; n=30; U=0; range 83.3–83.3% |

- Easy/Easy: W/L/D/U 11/19/0/0; mean 7.0 plies (4–13); 3948 nodes; node saturation 0.0%; fallbacks 0/211.

- Easy/Normal: W/L/D/U 9/21/0/0; mean 6.1 plies (4–9); 11079 nodes; node saturation 0.0%; fallbacks 0/183.

- Easy/Hard: W/L/D/U 8/22/0/0; mean 8.3 plies (5–24); 88929 nodes; node saturation 0.0%; fallbacks 0/248.

- Normal/Easy: W/L/D/U 16/14/0/0; mean 6.9 plies (4–12); 17228 nodes; node saturation 0.0%; fallbacks 0/208.

- Normal/Normal: W/L/D/U 14/16/0/0; mean 6.8 plies (5–12); 25694 nodes; node saturation 0.0%; fallbacks 0/204.

- Normal/Hard: W/L/D/U 13/17/0/0; mean 7.7 plies (5–14); 103992 nodes; node saturation 0.0%; fallbacks 0/231.

- Hard/Easy: W/L/D/U 23/7/0/0; mean 10.2 plies (4–18); 151388 nodes; node saturation 0.0%; fallbacks 0/307.

- Hard/Normal: W/L/D/U 26/4/0/0; mean 11.3 plies (4–25); 206656 nodes; node saturation 0.0%; fallbacks 0/340.

- Hard/Hard: W/L/D/U 25/5/0/0; mean 9.6 plies (5–19); 313453 nodes; node saturation 0.0%; fallbacks 0/289.
...
| Player / opponent | Easy | Normal | Hard |
|---|---|---|---|
| Easy | 66.7% [48.8, 80.8]; n=30; U=0; range 66.7–66.7% | 66.7% [48.8, 80.8]; n=30; U=0; range 66.7–66.7% | 66.7% [48.8, 80.8]; n=30; U=0; range 66.7–66.7% |
| Normal | 80.0% [62.7, 90.5]; n=30; U=0; range 80.0–80.0% | 73.3% [55.6, 85.8]; n=30; U=0; range 73.3–73.3% | 73.3% [55.6, 85.8]; n=30; U=0; range 73.3–73.3% |
| Hard | 83.3% [66.4, 92.7]; n=30; U=0; range 83.3–83.3% | 83.3% [66.4, 92.7]; n=30; U=0; range 83.3–83.3% | 83.3% [66.4, 92.7]; n=30; U=0; range 83.3–83.3% |

- Easy/Easy: W/L/D/U 20/10/0/0; mean 6.5 plies (3–23); 2605 nodes; node saturation 0.0%; fallbacks 0/194.

- Easy/Normal: W/L/D/U 20/10/0/0; mean 5.9 plies (3–13); 7072 nodes; node saturation 0.0%; fallbacks 0/176.

- Easy/Hard: W/L/D/U 20/10/0/0; mean 6.5 plies (3–13); 29891 nodes; node saturation 0.0%; fallbacks 0/194.

- Normal/Easy: W/L/D/U 24/6/0/0; mean 6.3 plies (3–13); 8602 nodes; node saturation 0.0%; fallbacks 0/190.

- Normal/Normal: W/L/D/U 22/8/0/0; mean 5.7 plies (3–11); 11970 nodes; node saturation 0.0%; fallbacks 0/172.

- Normal/Hard: W/L/D/U 22/7/1/0; mean 6.2 plies (3–19); 34117 nodes; node saturation 0.0%; fallbacks 0/187.

- Hard/Easy: W/L/D/U 25/4/1/0; mean 7.7 plies (3–15); 41595 nodes; node saturation 0.0%; fallbacks 0/231.

- Hard/Normal: W/L/D/U 25/5/0/0; mean 7.2 plies (3–15); 43706 nodes; node saturation 0.0%; fallbacks 0/215.

- Hard/Hard: W/L/D/U 25/5/0/0; mean 6.3 plies (3–13); 55245 nodes; node saturation 0.0%; fallbacks 0/189.
...
| Player / opponent | Easy | Normal | Hard |
|---|---|---|---|
| Easy | 46.7% [30.2, 63.9]; n=30; U=0; range 46.7–46.7% | 16.7% [7.3, 33.6]; n=30; U=0; range 16.7–16.7% | 13.3% [5.3, 29.7]; n=30; U=0; range 13.3–13.3% |
| Normal | 90.0% [74.4, 96.5]; n=30; U=0; range 90.0–90.0% | 53.3% [36.1, 69.8]; n=30; U=0; range 53.3–53.3% | 26.7% [14.2, 44.4]; n=30; U=0; range 26.7–26.7% |
| Hard | 96.7% [83.3, 99.4]; n=30; U=0; range 96.7–96.7% | 83.3% [66.4, 92.7]; n=30; U=0; range 83.3–83.3% | 60.0% [42.3, 75.4]; n=30; U=0; range 60.0–60.0% |

- Easy/Easy: W/L/D/U 14/15/1/0; mean 24.4 plies (16–47); 29645 nodes; node saturation 0.0%; fallbacks 0/733.

- Easy/Normal: W/L/D/U 5/24/1/0; mean 24.5 plies (16–47); 206575 nodes; node saturation 0.0%; fallbacks 0/736.

- Easy/Hard: W/L/D/U 4/25/1/0; mean 24.5 plies (14–48); 3369510 nodes; node saturation 17.5%; fallbacks 0/736.

- Normal/Easy: W/L/D/U 27/2/1/0; mean 23.2 plies (15–41); 209849 nodes; node saturation 0.0%; fallbacks 0/695.

- Normal/Normal: W/L/D/U 16/10/4/0; mean 25.6 plies (15–45); 381081 nodes; node saturation 0.0%; fallbacks 0/769.

- Normal/Hard: W/L/D/U 8/20/2/0; mean 25.8 plies (15–46); 3557152 nodes; node saturation 17.5%; fallbacks 0/773.

- Hard/Easy: W/L/D/U 29/1/0/0; mean 24.8 plies (15–57); 4048016 nodes; node saturation 21.0%; fallbacks 0/743.

- Hard/Normal: W/L/D/U 25/5/0/0; mean 24.2 plies (14–37); 3904668 nodes; node saturation 20.7%; fallbacks 0/725.

- Hard/Hard: W/L/D/U 18/9/3/0; mean 26.1 plies (16–43); 7345300 nodes; node saturation 38.0%; fallbacks 0/782.

## Ascension I

Map (10, -3); distance 14.
...
- Basics I → Basics II: 3.3-point drop; below spike threshold.
- Basics II → Basics III: 0.0-point drop; below spike threshold.
- Basics III → Patterns I: 20.0-point drop; followup candidate.
- Patterns I → Patterns II: -23.3-point drop; below spike threshold.
- Patterns II → Patterns III: 3.3-point drop; below spike threshold.
- Patterns III → Diagonals I: 16.7-point drop; below spike threshold.
- Diagonals I → Beams I: -16.7-point drop; below spike threshold.
- Beams I → Shields I: -10.0-point drop; below spike threshold.
- Shields I → Rite I: 23.3-point drop; followup candidate.
- Rite I → Rite II: -10.0-point drop; below spike threshold.
- Rite II → Rite III: 10.0-point drop; below spike threshold.
- Rite III → Rite IV: -3.3-point drop; below spike threshold.
- Rite IV → Ascension I: 0.0-point drop; below spike threshold.
- Ascension I → Ascension II: 16.7-point drop; below spike threshold.

### Optional route 1 (dead end)

- Diagonals I → Diagonals II: -6.7-point drop; below spike threshold.
...
- Shields I → Shields II: 56.7-point drop; supported candidate.
- Shields II → Shields III: -40.0-point drop; below spike threshold.

### Optional route 7 (dead end)

- Rite IV → Challenge I: 16.7-point drop; below spike threshold.
...
- Basics I: player Easy→Hard sensitivity against Normal: +26.7 points.
- Basics II: player Easy→Hard sensitivity against Normal: +73.3 points.
- Basics II: opponent-strength reversal for Easy player, Normal→Hard: +26.7 Red win points.
- Basics III: player Easy→Hard sensitivity against Normal: +36.7 points.
...
- Patterns III: player Easy→Hard sensitivity against Normal: +93.3 points.
...
- Diagonals I: player Easy→Hard sensitivity against Normal: +56.7 points.
