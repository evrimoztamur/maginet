...
Engine `fnv1a-1738a84d34e463e2`; bounded table capacity 32768 entries per search.
...
- Easy/Easy: W/L/D/U 28/2/0/0; mean 16.3 plies (7–25); 11478 nodes; node saturation 0.0%; fallbacks 0/489.

- Easy/Normal: W/L/D/U 20/9/1/0; mean 16.5 plies (5–26); 50379 nodes; node saturation 0.0%; fallbacks 0/495.

- Easy/Hard: W/L/D/U 24/5/1/0; mean 16.3 plies (7–30); 681705 nodes; node saturation 0.0%; fallbacks 0/489.

- Normal/Easy: W/L/D/U 29/1/0/0; mean 14.0 plies (7–23); 55983 nodes; node saturation 0.0%; fallbacks 0/419.

- Normal/Normal: W/L/D/U 29/1/0/0; mean 12.0 plies (7–21); 85826 nodes; node saturation 0.0%; fallbacks 0/359.

- Normal/Hard: W/L/D/U 29/1/0/0; mean 11.6 plies (7–21); 612713 nodes; node saturation 0.0%; fallbacks 0/349.

- Hard/Easy: W/L/D/U 30/0/0/0; mean 14.5 plies (7–23); 793012 nodes; node saturation 0.0%; fallbacks 0/434.

- Hard/Normal: W/L/D/U 30/0/0/0; mean 13.8 plies (7–26); 900976 nodes; node saturation 0.0%; fallbacks 0/413.

- Hard/Hard: W/L/D/U 30/0/0/0; mean 14.2 plies (7–23); 1409923 nodes; node saturation 0.0%; fallbacks 0/426.
...
| Player / opponent | Easy | Normal | Hard |
|---|---|---|---|
| Easy | 50.0% [33.2, 66.8]; n=30; U=0; range 50.0–50.0% | 26.7% [14.2, 44.4]; n=30; U=0; range 26.7–26.7% | 10.0% [3.5, 25.6]; n=30; U=0; range 10.0–10.0% |
| Normal | 73.3% [55.6, 85.8]; n=30; U=0; range 73.3–73.3% | 63.3% [45.5, 78.1]; n=30; U=0; range 63.3–63.3% | 20.0% [9.5, 37.3]; n=30; U=0; range 20.0–20.0% |
...
- Easy/Easy: W/L/D/U 15/15/0/0; mean 28.2 plies (16–45); 32595 nodes; node saturation 0.0%; fallbacks 0/846.

- Easy/Normal: W/L/D/U 8/21/1/0; mean 26.9 plies (14–44); 229222 nodes; node saturation 0.0%; fallbacks 0/806.

- Easy/Hard: W/L/D/U 3/25/2/0; mean 26.6 plies (14–39); 3731309 nodes; node saturation 16.8%; fallbacks 0/797.

- Normal/Easy: W/L/D/U 22/5/3/0; mean 26.9 plies (19–42); 222438 nodes; node saturation 0.0%; fallbacks 0/806.

- Normal/Normal: W/L/D/U 19/8/3/0; mean 25.5 plies (17–39); 411448 nodes; node saturation 0.0%; fallbacks 0/765.

- Normal/Hard: W/L/D/U 6/22/2/0; mean 27.4 plies (17–40); 4429933 nodes; node saturation 19.6%; fallbacks 0/822.

- Hard/Easy: W/L/D/U 29/1/0/0; mean 29.0 plies (21–47); 4606852 nodes; node saturation 18.9%; fallbacks 0/869.

- Hard/Normal: W/L/D/U 28/1/1/0; mean 29.3 plies (17–45); 4694768 nodes; node saturation 19.4%; fallbacks 0/880.

- Hard/Hard: W/L/D/U 19/7/4/0; mean 27.5 plies (14–39); 8488142 nodes; node saturation 37.4%; fallbacks 0/824.
...
| Normal | 73.3% [55.6, 85.8]; n=30; U=0; range 73.3–73.3% | 70.0% [52.1, 83.3]; n=30; U=0; range 70.0–70.0% | 36.7% [21.9, 54.5]; n=30; U=0; range 36.7–36.7% |
...
| Hard | 90.0% [74.4, 96.5]; n=30; U=0; range 90.0–90.0% | 70.0% [52.1, 83.3]; n=30; U=0; range 70.0–70.0% | 46.7% [30.2, 63.9]; n=30; U=0; range 46.7–46.7% |
...
- Easy/Hard: W/L/D/U 4/25/1/0; mean 25.9 plies (16–37); 3790431 nodes; node saturation 17.9%; fallbacks 0/777.
...
- Normal/Hard: W/L/D/U 12/16/2/0; mean 25.3 plies (15–45); 3993783 nodes; node saturation 18.9%; fallbacks 0/760.

- Hard/Easy: W/L/D/U 30/0/0/0; mean 22.9 plies (15–33); 4073697 nodes; node saturation 23.3%; fallbacks 0/686.

- Hard/Normal: W/L/D/U 27/1/2/0; mean 24.5 plies (17–35); 3992490 nodes; node saturation 20.7%; fallbacks 0/736.

- Hard/Hard: W/L/D/U 26/2/2/0; mean 26.5 plies (17–35); 8094841 nodes; node saturation 37.2%; fallbacks 0/795.
...
- Easy/Easy: W/L/D/U 29/0/1/0; mean 2.2 plies (1–18); 949 nodes; node saturation 0.0%; fallbacks 0/67.

- Easy/Normal: W/L/D/U 29/0/1/0; mean 2.2 plies (1–18); 2119 nodes; node saturation 0.0%; fallbacks 0/67.

- Easy/Hard: W/L/D/U 29/0/1/0; mean 2.1 plies (1–18); 7931 nodes; node saturation 0.0%; fallbacks 0/63.
...
- Hard/Easy: W/L/D/U 28/2/0/0; mean 4.5 plies (1–19); 48082 nodes; node saturation 0.0%; fallbacks 0/134.

- Hard/Normal: W/L/D/U 27/3/0/0; mean 5.3 plies (1–19); 56040 nodes; node saturation 0.0%; fallbacks 0/159.

- Hard/Hard: W/L/D/U 28/2/0/0; mean 3.9 plies (1–19); 55245 nodes; node saturation 0.0%; fallbacks 0/118.
...
- Patterns I: player Easy→Hard sensitivity against Normal: +66.7 points.
