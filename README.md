...
Settings, editor tools, main/campaign navigation, and battle menu/undo/result buttons have larger visible hit areas. Editor dimensions sit in the left margin so an 8×8 board remains unobstructed. Touch devices and native mobile builds omit the mouse cursor.
