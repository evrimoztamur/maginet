...
(async()=>{
 ...
 for(let i=0;i<2;i++){
   ...
   await client.click(248,110);await client.click(208,80);await client.click(128,200);
   await delay(1300);
 }
 await delay(1300);
 ...
 const point=(client,tile)=>client.point((8-board.width)*16+tile[0]*32+16,(8-board.height)*16+tile[1]*32+16);
