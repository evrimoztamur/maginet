...
def main():
    ...
    text = ['# Deadlock overcharge: paired campaign assessment', '',
            ...
            f"Across {overall['before']['n']:,} paired games per arm, draws change from **{overall['before']['outcomes']['Draw']} to {overall['after']['outcomes']['Draw']}**, and Red wins from **{overall['before']['outcomes']['Win']:,} to {overall['after']['outcomes']['Win']:,}**. Overcharge activates in {overall['after']['overcharged']} games. The [interpretation](interpretation.md) discusses the size of the effect, followup evidence and coverage limits.", '',
