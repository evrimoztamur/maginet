use shared::{Board, LobbySettings, LobbySort, DEFAULT_BOARD_SIZE};
...
const BUTTON_MODE_TOGGLE: usize = 0;
...
impl EditorState {
    pub fn new() -> EditorState {
        ...
        let root_element = Interface::new(vec![Box::new(button_mode_toggle)]);
